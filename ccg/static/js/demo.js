...
shopping.controller('ListCtrl', function ListCtrl($scope, $log, $http, ModelUtils) {
    ...
    $scope.loadItems = function() {
        $scope.items = $http.get('/shop/api/item/').then(function(response) {
    ...
    $scope.saveItem = function() {
        ModelUtils.save('/shop/api/item/',$scope.currentItem, $scope.errors).then(function() {
            $scope.loadItems();
            $scope.currentItem = {};
        });
    };
    ...
    $scope.delItem = function(item) {
        ModelUtils.del('/shop/api/item/', item).then(function() {
            $scope.loadItems();
        });
